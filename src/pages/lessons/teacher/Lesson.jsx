...
//   lessonName: "",
//   lessonNumber: "",
//   endDate: "", // Dars tugash vaqtini initial statega qo'shdik
...
//   const [deleteLesson] = useDeleteLessonMutation(id);
...
//   // Dars tugash vaqtini o'zgartirish va vaqtni moslashtirish
//   const handleEndDateChange = (e) => {
//     const selectedDate = new Date(e.target.value); // Inputdan olingan vaqt
//     const adjustedDate = new Date(selectedDate.getTime()); // 5 soatni qo'shish
//     setFormData({
//       ...formData,
//       endDate: adjustedDate.toISOString().slice(0, 16), // To'g'ri formatda vaqtni saqlash
//     });
//   };
...
//     // Dars tugash vaqtini tekshirib qo'yish
//     if (!formData.endDate) {
...
//       </div>
//       {isModalOpen && (
//         <Module close={setIsModalOpen} width={800} bg={"#aaa6"}>
...
//               />
//               {/* 3-chi inputga dars tugash vaqtini qo'shamiz */}
//               <input
//                 required
//                 type="datetime-local"
//                 value={formData.endDate}
//                 onChange={handleEndDateChange} // o'zgartirilgan handler
//                 name="endDate"
